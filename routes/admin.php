...
use App\Livewire\Categories\Form as CategoriesForm;
use App\Livewire\Subcategories\Form as SubcategoriesForm;
...
Route::middleware(['auth', \App\Http\Middleware\EnsureSuperAdmin::class])
    ...
    ->group(function () {
        ...
        Route::get('/categories/create', CategoriesForm::class)->name('admin.categories.create');
        Route::get('/categories/{categoryId}/edit', CategoriesForm::class)->name('admin.categories.edit');
        Route::get('/subcategories/create', SubcategoriesForm::class)->name('admin.subcategories.create');
        Route::get('/subcategories/{subcategoryId}/edit', SubcategoriesForm::class)->name('admin.subcategories.edit');
