        ...
        <tbody>
            @forelse ($commissions as $c)
                @php
                    ...
                    $order = $c->booking ?? $c->parcelOrder ?? $c->taxiRide ?? $c->propertyReservation ?? $c->marketplaceOrder ?? $c->rentalReservation ?? $c->hotelReservation;
                    $earner = match (true) {
                        ...
                        (bool) $c->hotelReservation => $c->hotelReservation->accommodation?->provider?->user,
                        default => null,
                    };
                @endphp
