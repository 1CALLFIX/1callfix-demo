<div>
    ...
    <div class="flex items-center justify-between mt-2 mb-4">
        ...
        <div class="flex items-center gap-2">
            <x-ui.badge size="lg" :color="match($fieldWorker->kyc_status) { 'pending' => 'amber', 'approved' => 'green', 'rejected' => 'red', default => 'gray' }">
                {{ ucfirst($fieldWorker->kyc_status) }}
            </x-ui.badge>
            <x-ui.badge size="lg" :color="$fieldWorker->is_active ? 'green' : 'gray'">
        ...
        <x-ui.card>
            ...
            <dl class="text-sm space-y-1">
                ...
                <div class="flex justify-between items-center pt-2 border-t mt-2">
                    ...
                    <dd><x-ui.button size="sm" wire:click="toggleActive">{{ $fieldWorker->is_active ? 'Deactivate' : 'Activate' }}</x-ui.button></dd>
                </div>
            </dl>
        </x-ui.card>
    ...
    <x-ui.card class="mb-6">
        ...
        <div class="flex flex-wrap items-end gap-2">
            ...
            <x-ui.button size="sm" wire:click="addCapability">Add Capability</x-ui.button>
        </div>
    ...
    @if ($fieldWorker->kyc_status === 'pending')
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <x-ui.card>
                ...
                <x-ui.button variant="success" size="lg" class="w-full" wire:click="approve">Approve Worker</x-ui.button>
            </x-ui.card>
            ...
            <x-ui.card>
                ...
                <x-ui.button variant="danger" size="lg" class="w-full" wire:click="reject">Reject Worker</x-ui.button>
            </x-ui.card>
        </div>
    @endif
</div>
