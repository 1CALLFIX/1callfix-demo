...
class GoogleAuth extends Component
{
    ...
    public function phoneTokenReceived(string $idToken, FirebaseTokenVerifier $firebase, CustomerAccountResolver $accounts): void
    {
        ...
        // The 'link' branch above already refuses a suspended account
        // before this point is ever reached; 'new' just created a brand
        // new (necessarily active) account. Nothing left to check here.
        session()->forget('auth.google');
