 ...
 * toggleUserSuspended() for staff, and Providers\Show::
 * toggleAccountSuspended() for providers) but was never checked anywhere,
 ...
 * App\Livewire\Auth\Login (admin) and App\Livewire\Provider\Auth\Login
 * (provider) each get the identical check inline since they only have the
 * one call site apiece.
 *
